...
This query returns only the teacher with the `id = 1` because student 1 is in the first teachers class and students 2 and 3 have not been assigned a teacher id, they are shown as 'NULL'.
